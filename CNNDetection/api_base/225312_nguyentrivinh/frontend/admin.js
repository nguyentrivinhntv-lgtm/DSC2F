...
async function fetchPaymentHistory() {
    ...
    try {
        const res = await fetch(`${API_URL}/payment-history/?all=true`, { credentials: 'include', 
            headers: {
...
async function fetchDeletionRequests() {
    ...
    try {
        const res = await fetch(`${API_URL}/auth/deletion-requests`, { credentials: 'include', 
            headers: {  }
        });
...
window.updateDeletionRequest = async function(reqId, status) {
    ...
    try {
        const res = await fetch(`${API_URL}/auth/deletion-requests/${reqId}`, { credentials: 'include', 
            method: 'PUT',
            headers: { 
...
async function fetchAdminHistory() {
    ...
    try {
        const res = await fetch(`${API_URL}/history/?all=true`, { credentials: 'include', 
            headers: {
...
async function fetchAdminModels() {
    ...
    try {
        const res = await fetch(`${API_URL}/admin/models`, { credentials: 'include', 
            headers: {
...
async function toggleModel(modelType, checkbox) {
    ...
    try {
        const res = await fetch(`${API_URL}/admin/models/toggle`, { credentials: 'include', 
            method: 'POST',
            headers: {
                'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function topupUserTokens() {
    ...
    try {
        const res = await fetch(`${API_URL}/auth/admin/tokens/topup`, { credentials: 'include', 
            method: 'POST',
            headers: {
                'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function fetchAdminUsers() {
    ...
    try {
        const res = await fetch(`${API_URL}/auth/admin/users`, { credentials: 'include', 
            headers: {  }
        });
...
async function changeUserRole(username, newRole) {
    ...
    try {
        const res = await fetch(`${API_URL}/auth/admin/users/role`, { credentials: 'include', 
            method: 'POST',
            headers: {
                'Content-Type': 'application/json' },
...
async function fetchSiteConfig() {
    try {
        const token = localStorage.getItem('token');
        const res = await fetch(`${API_URL}/admin/site-config`, { credentials: 'include', 
            headers: {  }
        });
        if (!res.ok) return;
...
async function resetSiteConfig() {
    ...
    try {
        const res = await fetch(`${API_URL}/admin/site-config/reset`, { credentials: 'include', 
            method: 'POST',
            headers: {
...
async function uploadLogo(file) {
    ...
    try {
        const res = await fetch(`${API_URL}/admin/upload-image`, { credentials: 'include', 
            method: 'POST',
            headers: {
        ...
        btnAiTranslate.addEventListener('click', async () => {
            ...
            for (const [fieldId, baseKey] of Object.entries(CONFIG_FIELDS)) {
                if (MULTILANG_CONFIG_KEYS.includes(baseKey)) {
                    ...
                    try {
                        const res = await fetch(`${API_URL}/admin/ai-translate`, { credentials: 'include', 
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json' },
                            body: JSON.stringify({
...
async function loadPagesList() {
    ...
    try {
        const response = await fetch(`${API_URL}/pages?is_admin=true`, { credentials: 'include', 
            headers: {  },
            cache: 'no-store'
        });
...
async function editPage(slug) {
    try {
        const response = await fetch(`${API_URL}/pages/${slug}`, { credentials: 'include', 
            headers: {  }
        });
...
async function fetchScheduledNotifications() {
    ...
    try {
        const res = await fetch(`${API_URL}/notifications/admin/scheduled`, { credentials: 'include', 
            headers: {  }
        });
...
async function deleteScheduledNotif(id) {
    ...
    try {
        const res = await fetch(`${API_URL}/notifications/admin/scheduled/${id}`, { credentials: 'include', 
            method: 'DELETE',
            headers: {  }
        });
