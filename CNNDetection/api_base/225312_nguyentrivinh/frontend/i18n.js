const translations = {
    vi: {
        ...
        "lang_vi": "Tiếng Việt",
        "lang_en": "Tiếng Anh",
        "btn_ai_translate_all": "Dịch tất cả (AI)",
        "alert_switch_en": "Vui lòng chuyển sang 'Tiếng Anh' để dịch tự động!",
        "confirm_ai_translate": "Bạn có chắc muốn dùng AI tự động dịch các trường nội dung sang Tiếng Anh không?",
        ...
        "ui_contact_email": "Email liên hệ",
        "ui_contact_phone": "Số điện thoại",
        "ui_footer_desc": "Mô tả chân trang",
        "ui_footer": "Copyright chân trang",
        ...
        "ui_vnpay": "Cấu hình VNPay",
        "tab_api_config": "Cấu hình API",
        "admin_api_desc": "Quản lý các kết nối với bên thứ 3 (Google Login, Gửi Mail, Cổng Thanh Toán).",
        "btn_reset": "Khôi phục mặc định",
        "vnpay_tmn_desc": "Mã website của bạn được VNPay cấp.",
        "vnpay_hash_desc": "Khóa bí mật dùng để tạo chữ ký bảo mật.",
        "vnpay_url_desc": "Đường dẫn API khởi tạo giao dịch VNPay (Sandbox hoặc Production).",
        "vnpay_return_desc": "Đường dẫn nhận kết quả trả về sau khi người dùng thanh toán xong.",
        // --- Extra Missing ---
        ...
        "nav_home": "Quay về trang chủ",
        "page_not_found": "Không tìm thấy trang",
        "page_not_found_desc": "Trang bạn đang tìm kiếm không tồn tại hoặc đã bị gỡ bỏ.",
        "btn_back_home": "Quay lại Trang chủ",
        "title_delete_request": "Yêu cầu xóa tài khoản",
        "subtitle_delete_request": "Chúng tôi sẽ xử lý yêu cầu trong vòng 7 ngày làm việc",
        "lbl_important_warning": "Lưu ý quan trọng trước khi xóa tài khoản:",
        "form_title_fill": "Điền thông tin để gửi yêu cầu",
        "lbl_contact_info": "Số điện thoại / Email đăng ký *",
        "lbl_delete_reason": "Lý do xóa tài khoản",
        "opt_reason_placeholder": "Chọn lý do (không bắt buộc)",
        "opt_reason_1": "Không còn nhu cầu sử dụng",
        "opt_reason_2": "Trải nghiệm dịch vụ không tốt",
        "opt_reason_3": "Tạo tài khoản mới",
        "opt_reason_other": "Lý do khác",
        "lbl_delete_note": "Ghi chú thêm",
        "btn_submit_delete": "Gửi yêu cầu xóa tài khoản",
        "title_direct_contact": "Liên hệ trực tiếp",
        "desc_direct_contact": "Nếu gặp khó khăn, bạn có thể gửi yêu cầu xóa tài khoản qua email:",
        "desc_email_format": "Tiêu đề email: \"Yêu cầu xóa tài khoản\" + số điện thoại / email đăng ký.",
        "title_request_success": "Đã gửi yêu cầu thành công!",
        "desc_request_success": "Hệ thống đã ghi nhận yêu cầu xóa tài khoản của bạn. Chúng tôi sẽ xử lý yêu cầu trong vòng 7 ngày làm việc.",
        ...
        "tab_deletion_requests": "Yêu cầu Xóa TK",
        "desc_deletion_requests": "Quản lý các yêu cầu vô hiệu hóa tài khoản từ người dùng.",
        "col_req_id": "ID",
        "col_req_contact": "Tài khoản / SĐT",
        "col_req_reason": "Lý do",
        "col_req_date": "Ngày yêu cầu",
        "col_req_status": "Trạng thái",
        "col_req_action": "Hành động",
        "loading_requests": "Đang tải danh sách yêu cầu...",
        "empty_requests": "Chưa có yêu cầu nào.",
        "warn_delete_1": "Toàn bộ thông tin cá nhân và lịch sử phân tích sẽ bị xóa vĩnh viễn.",
        "warn_delete_2": "Bạn sẽ không thể khôi phục tài khoản sau khi xóa.",
        "warn_delete_3": "Các giao dịch/đơn hàng đang xử lý (nếu có) cần được hoàn thành trước.",
        "ph_req_contact": "Nhập số điện thoại hoặc email",
        "ph_req_note": "Mô tả thêm (không bắt buộc)",
    ...
    en: {
        ...
        "lang_vi": "Vietnamese",
        "lang_en": "English",
        "btn_ai_translate_all": "Translate all (AI)",
        "alert_switch_en": "Please switch Configuration Language to 'English' to use auto-translate!",
        "confirm_ai_translate": "Are you sure you want to use AI to automatically translate all text fields into English?",
        ...
        "ui_slogan": "Slogan / Short Description",
        "ui_contact_email": "Contact Email",
        "ui_contact_phone": "Phone Number",
        "ui_footer_desc": "Footer Description",
        "ui_footer": "Footer Copyright",
        ...
        "ui_vnpay": "VNPay Configuration",
        "tab_api_config": "Third-Party APIs",
        "admin_api_desc": "Manage connections with third-party services (Google Login, Email SMTP, Payment Gateways).",
        "btn_reset": "Restore Defaults",
        "vnpay_tmn_desc": "Your website ID provided by VNPay.",
        "vnpay_hash_desc": "Secret key used to generate secure hashes.",
        "vnpay_url_desc": "VNPay API endpoint for initiating transactions (Sandbox or Production).",
        "vnpay_return_desc": "Return URL to receive payment results after user completes the transaction.",
        // --- Extra Missing ---
        ...
        "btn_back_home": "Back to Home",
        "title_delete_request": "Account Deletion Request",
        "subtitle_delete_request": "We will process your request within 7 working days",
        "lbl_important_warning": "Important note before deleting your account:",
        "form_title_fill": "Fill out the form to submit request",
        "lbl_contact_info": "Registered Phone / Email *",
        "lbl_delete_reason": "Reason for deletion",
        "opt_reason_placeholder": "Select a reason (optional)",
        "opt_reason_1": "No longer needed",
        "opt_reason_2": "Poor service experience",
        "opt_reason_3": "Create a new account",
        "opt_reason_other": "Other reasons",
        "lbl_delete_note": "Additional note",
        "btn_submit_delete": "Submit Deletion Request",
        "title_direct_contact": "Contact Directly",
        "desc_direct_contact": "If you encounter difficulties, you can request account deletion via email:",
        "desc_email_format": "Email subject: \"Account Deletion Request\" + registered phone / email.",
        "title_request_success": "Request Submitted!",
        "desc_request_success": "Your account deletion request has been recorded. We will process your request within 7 working days.",
        "lp_footer": "&copy; 2026 CNN Detection Hub &mdash; AI Deepfake Detection Platform",
        ...
        // --- Admin Deletion Requests ---
        "tab_deletion_requests": "Deletion Requests",
        "desc_deletion_requests": "Manage account deactivation requests from users.",
        "col_req_id": "ID",
        "col_req_contact": "Account / Phone",
        "col_req_reason": "Reason",
        "col_req_date": "Request Date",
        "col_req_status": "Status",
        "col_req_action": "Action",
        "loading_requests": "Loading requests...",
        "empty_requests": "No requests found.",
        "warn_delete_1": "All personal information and analysis history will be permanently deleted.",
        "warn_delete_2": "You will not be able to recover your account after deletion.",
        "warn_delete_3": "Any pending transactions/orders (if any) must be completed first.",
        "ph_req_contact": "Enter phone number or email",
        "ph_req_note": "Additional description (optional)",
