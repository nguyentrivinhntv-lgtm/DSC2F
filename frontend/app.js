...
async function initGoogleSignIn() {
    ...
    // App Mobile: Cho phép đăng nhập Google trực tiếp trong WebView qua trang mobile_login.html
    if (window.FlutterBridge) {
        googleSigninBtn.innerHTML = `
            <button type="button" onclick="window.location.href='mobile_login.html'" 
