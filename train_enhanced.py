"""
Training Script cho Enhanced Dual-Stream CNN
...
from networks.dual_stream_enhanced import DualStreamCNNEnhanced, compute_fft_spectrum
...
class EnhancedTrainer:
    def __init__(self, args):
        ...
        print("="*60)
        print("  ENHANCED DUAL-STREAM CNN TRAINING")
        print("="*60)
    ...
    def _build_model(self):
        self.model = DualStreamCNNEnhanced(
            num_classes=1, 
        ...
        print(f"Model: Enhanced Dual-Stream CNN")
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train Enhanced Dual-Stream CNN')
    ...
    parser.add_argument('--save_dir', type=str, default='weights/dual_stream_enhanced')
